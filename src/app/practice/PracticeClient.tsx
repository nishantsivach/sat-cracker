                            ...
                            {questions.map((_, i) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-8 h-8 rounded-lg text-xs font-mono font-bold transition-all ${isCurrent
                                ...
                                {question.options.map((opt, i) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3 rounded-xl border px-4 py-3.5 text-left transition-all ${stateClasses} ${selected === null ? "cursor-pointer" : "cursor-default"
                                                }`}
                                        >
                                            <span
                                                className={`w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold shrink-0 ${showState && isCorrect
                                ...
                                <div className="mt-5 p-4 bg-site-highlight rounded-xl border border-site-border">
                                    ...
                                    {selected !== question.correctIndex && (
                                        <Link
                                            ...
                                            className="mt-4 inline-flex items-center gap-2 rounded-xl bg-site-accent text-white px-4 py-2.5 text-xs font-bold hover:brightness-105 hover:shadow-lg hover:shadow-site-accent/25 hover:-translate-y-0.5 active:translate-y-0 transition-all cursor-pointer"
                                        >
                                ...
                                {questions.map((q, i) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-xl text-xs font-mono font-bold transition-all ${isCorrect
